  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="font-serif text-3xl font-semibold text-foreground">Promoções</h1>
          ...
          <table className="w-full min-w-[640px] text-left text-sm">
            ...
            <tbody>
              ...
              {campaigns.map((campaign) => (
                <tr key={campaign.id} className="border-b border-border/60 last:border-0 hover:bg-muted/40">
                  ...
                  <td className="px-5 py-3 text-right">
                    <Link to={`/promocoes/${campaign.id}`} className={buttonVariants({ variant: 'outline', size: 'sm' })}>
                      Ver detalhes
                    </Link>
                  </td>
                </tr>
