...
import { PriorRevenueController } from './interface/controllers/prior-revenue.controller';
...
@Module({
  ...
  controllers: [TenantTaxProfileController, PriorRevenueController, ProductTaxProfileController],
  providers: [
