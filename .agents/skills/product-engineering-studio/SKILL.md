...
projeto vive no `AGENTS.md` da raiz, nos `AGENTS.md` por app, em `.Codex/rules/` e em `docs/` —
...
1. Ler o `AGENTS.md` da raiz e o do app envolvido.
...
Atalho: `bash .Codex/skills/product-engineering-studio/scripts/validate-project.sh`
